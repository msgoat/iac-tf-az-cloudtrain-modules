...
config:
  ...
  outputs: |
    ...
    [OUTPUT]
        ...
        Type               _doc
        Logstash_Format    On
        Logstash_Prefix    k8s-${data.azurerm_kubernetes_cluster.given.name}
...
%{ endif ~}
    ...
    [OUTPUT]
        ...
        Type               _doc
        Logstash_Format    On
        Logstash_Prefix    sys-${data.azurerm_kubernetes_cluster.given.name}
        Time_Key           @flb-timestamp
        Generate_ID        On
        Replace_Dots       On
        Retry_Limit        3
...
%{ endif ~}
    ...
    [OUTPUT]
        ...
        Type               _doc
        Logstash_Format    On
        Logstash_Prefix    tools-${data.azurerm_kubernetes_cluster.given.name}
        Time_Key           @flb-timestamp
        Generate_ID        On
        Replace_Dots       On
        Retry_Limit        3
...
%{ endif ~}
    ...
    [OUTPUT]
        ...
        Type               _doc
        Logstash_Format    On
        Logstash_Prefix    apps-${data.azurerm_kubernetes_cluster.given.name}
        Time_Key           @flb-timestamp
        Generate_ID        On
        Replace_Dots       On
        Retry_Limit        3
